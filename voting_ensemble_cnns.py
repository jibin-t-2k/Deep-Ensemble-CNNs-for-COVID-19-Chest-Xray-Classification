...
with strategy.scope():
  ensemble_model = build_efficientb7_model()
...
ensemble_model = load_model("voting_ensemble.h5")    
...
plot_confusion_matrix(cm = conf_matrix, normalize = False,  target_names = ["COVID", "Lung_Opacity", "Normal", "Viral_Pneumonia"], title = "Voting Ensemble Model")